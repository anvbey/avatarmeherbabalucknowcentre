  ...
  return (
    <Box>
      <Box sx={{ display: "block" }}>
        ...
        Shri. G.D. Panchal, Shri. M.D. Shastri, and Shri. S.R. Sharma. Shri. S.S. Dubey was the veteran Baba 
        lover who brought Beloved Baba’s name to Lucknow. By this time, Shri. S.S. Dubey had considerably spread 
        Meher Baba’s name and love among his family, friends, colleagues, and neighbours, which resulted in a 
        number of people coming into Baba’s love net. Gradually, satsang programs started being held every month 
        at the residences of Shri. G.P. Dubey and Smt. Bindu Dubey, Shri. K.K. Sharma, Shri. Ram Prasad, and Shri. J.K. Verma.<br/><br/>

        With time, Smt. Mithilesh Srivastava, a colleague of Shri. S.S. Dubey, and her husband, 
        Shri. K.K. Srivastava also became ardent Baba lovers. To commemorate Baba's poor feeding 
        program in Lucknow and to celebrate its ‘Golden Jubilee’, the AMBC, Lucknow was inaugurated on 
        23rd October 1993 by Dr. H.P. Bharucha, from Navsari at the residence of Shri. K.K. Srivastava and 
        Smt. Mithilesh Srivastava at 169, Samar Vihar Colony, Lucknow. Since then, every year, the celebration 
        of Meher Baba’s birthday, which was earlier celebrated at the centre at Charbagh, shifted to this Centre 
        at Samar Vihar Colony which is followed even today. Apart from this, satsang programs are held at the 
        Centre on the first Sunday of every month and the 23rd of every month, along with bi-annual celebrations 
        remembering Baba’s visits to Lucknow on the 16th of May and the 23rd of October. <br/><br/>
      ...
      <Box sx={{ display: "block" }}>
        ...
        His message of Love and Truth among the masses through many more Baba programs and related activities 
        in the times to come.<br/><br/>
        </Typography>
      </Box>
    </Box>
  );
